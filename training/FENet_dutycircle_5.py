...
model = keras.Model(inputs=[Input], outputs=[n0, n1, n2, n3, n4])
...
model.fit(training_x,
          {'nn_block': TrainL(-2), 'nn_block_1': TrainL(-1), 'nn_block_2': TrainL(0), 'nn_block_3': TrainL(1), 'nn_block_4': TrainL(2)},
          callbacks=[
              tensorboard_callback,
              #check_callback
          ],
          validation_data = (test_x, {'nn_block': TestL(-2), 'nn_block_1': TestL(-1), 'nn_block_2': TestL(0), 'nn_block_3': TestL(1), 'nn_block_4': TestL(2)}),
