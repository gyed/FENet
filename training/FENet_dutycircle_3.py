...
model = keras.Model(inputs=[Input], outputs=[n0, n1, n2])
...
model.fit(training_x,
          {'nn_block': TrainL(-1), 'nn_block_1': TrainL(0), 'nn_block_2': TrainL(1)},
          callbacks=[
              tensorboard_callback,
              #check_callback
          ],
          validation_data = (test_x, {'nn_block': TestL(-1), 'nn_block_1': TestL(0), 'nn_block_2': TestL(1)}),
