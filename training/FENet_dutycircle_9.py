...
model.fit(training_x,
          {'nn_block': TrainL(-4), 'nn_block_1': TrainL(-3), 'nn_block_2': TrainL(-2), 'nn_block_3': TrainL(-1), 'nn_block_4': TrainL(0), 'nn_block_5': TrainL(1), 'nn_block_6': TrainL(2), 'nn_block_7': TrainL(3), 'nn_block_8': TrainL(4)},
          callbacks=[
              tensorboard_callback,
              #check_callback
          ],
          validation_data = (test_x, {'nn_block': TestL(-4), 'nn_block_1': TestL(-3), 'nn_block_2': TestL(-2), 'nn_block_3': TestL(-1), 'nn_block_4': TestL(0), 'nn_block_5': TestL(1), 'nn_block_6': TestL(2), 'nn_block_7': TestL(3), 'nn_block_8': TestL(4)}),
